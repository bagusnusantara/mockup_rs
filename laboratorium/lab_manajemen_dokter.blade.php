        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="lab_manajemen_dokter_tambah.blade.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Dokter</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="lab_manajemen_dokter_edit.blade.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
