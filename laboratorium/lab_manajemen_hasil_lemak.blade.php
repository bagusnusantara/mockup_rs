        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4 col-3">
                    <h4 class="page-title">Daftar hasil Test Lemak Patient</h4>
                </div>
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="../add-patient.html" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Hasil</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h3>Apakah anda ingin menghapus hasil ini?</h3>
