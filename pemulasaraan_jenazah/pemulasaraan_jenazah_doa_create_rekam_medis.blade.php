...
<div class="main-wrapper">
    <?php include ('pemulasaraan_jenazah_temp_top_navbar.blade.php') ?>
    <?php include ('pemulasaraan_jenazah_temp_side_navbar.blade.php') ?>
...
<?php include ('pemulasaraan_jenazah_temp_footer.blade.php') ?>
<script>
    $(document).ready(function () {
        // $('.nav>li').removeClass('active');
        // $('#nav-doa-rm').addClass('active');
    });
</script>
</body>
</html>
