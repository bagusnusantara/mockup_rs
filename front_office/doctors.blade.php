            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <!-- <a href="add-doctor.html" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Data Dokter</a> -->
                    </div>
                </div>
				<div class="row doctor-grid">
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Kediri, Jawa Timur
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Tulungagung, Jawa Timur
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Bangkalan, Madura
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Sukoharjo, Jawa Tengah
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Madiun, Jawa Timur
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> Sumenep, Madura
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4  col-lg-3">
